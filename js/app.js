 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".makes__slider")) new core(".makes__slider", {
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                spaceBetween: 20,
        ...
        if (document.querySelector(".stories__slider")) new core(".stories__slider", {
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 0,
